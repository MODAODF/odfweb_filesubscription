...
templates['sidebar-tabview'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n    <div class=\"itemEntry\">\n        <div class=\"entryAvatar "
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"shareId") || (depth0 != null ? lookupProperty(depth0,"shareId") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"shareId","hash":{},"data":data,"loc":{"start":{"line":32,"column":36},"end":{"line":32,"column":47}}}) : helper)))
    + "\" type=\"button\">儲存</button>\n            </div>\n        </li>\n\n        <li>\n            <div>\n                <div class=\"icon icon-mail\"></div>\n                <span>訂閱郵件</span>\n                <span class=\"msg hidden\"></span>\n            </div>\n            <button class=\"mailBtn\" type=\"button\">傳送電子郵件("
    + alias4(((helper = (helper = lookupProperty(helpers,"subscriberNum") || (depth0 != null ? lookupProperty(depth0,"subscriberNum") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"subscriberNum","hash":{},"data":data,"loc":{"start":{"line":42,"column":57},"end":{"line":42,"column":74}}}) : helper)))
    + ")</button>\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"updateAt") : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":43,"column":12},"end":{"line":45,"column":19}}})) != null ? stack1 : "")
    + "        </li>\n    </ul>\n";
},"useData":true});
})();