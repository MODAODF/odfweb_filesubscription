...
templates['sidebar-invaildItem'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                (<span>"
    ...
    return "                <button class=\"downloadLog\" type=\"button\">下載通知紀錄</button>\n";
},"5":function(container,depth0,helpers,partials,data) {
    return "                <div>此分享連結無訂閱通知紀錄</div>\n";
...
templates['sidebar-vaildItem'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "            <div class=\"lasttime\"><em>上次取消於 <span>"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"lastCancelTime") || (depth0 != null ? lookupProperty(depth0,"lastCancelTime") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"lastCancelTime","hash":{},"data":data,"loc":{"start":{"line":63,"column":50},"end":{"line":63,"column":68}}}) : helper)))
    + "</span></em></div>\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n    <div class=\"itemEntry\">\n        <div class=\"entryAvatar "
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"buttonDisable") || (depth0 != null ? lookupProperty(depth0,"buttonDisable") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"buttonDisable","hash":{},"data":data,"loc":{"start":{"line":45,"column":57},"end":{"line":45,"column":74}}}) : helper)))
    + ">傳送訂閱郵件("
    + alias4(((helper = (helper = lookupProperty(helpers,"subscriberNum") || (depth0 != null ? lookupProperty(depth0,"subscriberNum") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"subscriberNum","hash":{},"data":data,"loc":{"start":{"line":45,"column":82},"end":{"line":45,"column":99}}}) : helper)))
    + ")\n            </button>\n            <div class=\"lasttime\">\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"lastEmailTime") : depth0),{"name":"if","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":48,"column":16},"end":{"line":50,"column":23}}})) != null ? stack1 : "")
    + "            </div>\n        </li>\n\n        <li>\n            <div>\n                <div class=\"icon icon-delete\"></div>\n                <span>取消訂閱</span>\n                <span class=\"msg hidden\"></span>\n            </div>\n            <button class=\"cancelSubscr\" type=\"button\" "
    + alias4(((helper = (helper = lookupProperty(helpers,"buttonDisable") || (depth0 != null ? lookupProperty(depth0,"buttonDisable") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"buttonDisable","hash":{},"data":data,"loc":{"start":{"line":60,"column":55},"end":{"line":60,"column":72}}}) : helper)))
    + ">取消訂閱者("
    + alias4(((helper = (helper = lookupProperty(helpers,"subscriberNum") || (depth0 != null ? lookupProperty(depth0,"subscriberNum") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"subscriberNum","hash":{},"data":data,"loc":{"start":{"line":60,"column":79},"end":{"line":60,"column":96}}}) : helper)))
    + ")</button>\n\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"lastCancelTime") : depth0),{"name":"if","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":62,"column":12},"end":{"line":64,"column":19}}})) != null ? stack1 : "")
    + "        </li>\n    </ul>\n";
},"useData":true});
})();