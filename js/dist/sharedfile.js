...
var SharedFile = {
  ...
  _onUnsubscrEvent: function _onUnsubscrEvent(e) {
    e.stopPropagation();
    e.preventDefault();
    var msgEl = $('#subscription-content .msg');
    var msgResponse = {
