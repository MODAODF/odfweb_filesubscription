...
templates['sharedfile-header'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"subscription-icon\" class=\"icon-mail\"></div>\n\n<div id=\"subscription-content\" class=\"popovermenu hidden\">\n    <div class=\"content\">\n        <h3>"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"tokendescription") || (depth0 != null ? lookupProperty(depth0,"tokendescription") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"tokendescription","hash":{},"data":data,"loc":{"start":{"line":17,"column":16},"end":{"line":17,"column":36}}}) : helper)))
    + "</em>\n            <div id=\"subscription-api\">\n                <input id=\"apicode\" type=\"text\" name=\"apicode\" value=\"\" readonly=\"readonly\" />\n                <button class=\"icon-clippy\"></button>\n            </div>\n        </div>\n    </div>\n</div>\n";
},"useData":true});
